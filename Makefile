NAME = miniRT
CFLAGS = -std=gnu11 -Wall -Werror -Wextra -g -I./minilibx
SRCS = source/main.c source/camera_init.c source/utils.c source/vec3.c source/random.c source/sphere.c source/handle_render_loop_utils.c source/hittable.c source/vec3_ops4.c source/material.c source/hittable_list.c source/color.c source/interval.c source/ray.c source/vec3_utils.c source/vec3_ops.c source/vec3_ops2.c source/vec3_ops3.c source/vec3_print.c source/plane.c source/cylinder.c source/cylinder_quadratic.c source/cylinder_caps.c source/sphere_quadratic.c source/validation/validate_file.c source/parsing/parse_ambient.c source/parsing/parse_camera.c source/parsing/parse_cylinder.c source/parsing/parse_light.c source/parsing/parse_file.c source/parsing/parse_plane.c source/parsing/parse_sphere.c source/validation/validation_utils.c source/validation/validation_utils2.c source/validation/validate_elements.c source/validation/validate_elements2.c source/key_hooks.c source/handle_render_loop.c source/handle_render.c source/phone_lighting.c
OBJS = $(SRCS:%.c=%.o)
